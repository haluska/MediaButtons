...
3. Button and LED Male Header
    ...
    3. SEMI-IMPORTANT: If you skip soldering header pins 13 and 18, you can just pull the unsoldered header pins out when you're done soldering the rest. This will make it all a little cleaner.
4. Cut the Traces
...
6. Solder ground for the LED, Buttons, Rotary Encoder
    1. Make 7 jumpers: cut and strip about 2" of wire and then cut it into 7 even lengths
